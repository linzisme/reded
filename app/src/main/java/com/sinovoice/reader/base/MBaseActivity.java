...
package com.sinovoice.reader.base;
...
import android.support.v7.app.AppCompatDelegate;
import com.sinovoice.basemvplib.BaseActivity;
...
public abstract class MBaseActivity<T extends IPresenter> extends BaseActivity<T> {
    public final SharedPreferences preferences = ReaderApplication.getInstance().getConfigPreferences();
