package com.sinovoice.reader.widget.page.animation;
...
public abstract class PageAnimation {
     ...
     */
    public enum Mode {
        COVER(ReaderApplication.getAppResources().getString(R.string.page_mode_COVER)),
        SIMULATION(ReaderApplication.getAppResources().getString(R.string.page_mode_SIMULATION)),
        SLIDE(ReaderApplication.getAppResources().getString(R.string.page_mode_SLIDE)),
        SCROLL(ReaderApplication.getAppResources().getString(R.string.page_mode_SCROLL)),
        NONE(ReaderApplication.getAppResources().getString(R.string.page_mode_NONE));
